...
describe('Module 4 Project Tests', () => {
  describe('English Language', () => {
    ...
    */
    ...
    test(`TEXT_FAV_LANG_JS is visible`, () => {
      render(<App lang="en" />)
      expect(screen.getByText(index.en.TEXT_FAV_LANG_JS)).toBeVisible()
    })
    test(`TEXT_FAV_LANG_RUST is visible`, () => {
      render(<App lang="en" />)
      expect(screen.getByText(index.en.TEXT_FAV_LANG_RUST)).toBeVisible()
    })
    ...
    test(`TEXT_SUBMIT is visible`, () => {
      render(<App lang="en" />)
      expect(screen.getByText(index.en.TEXT_SUBMIT)).toBeVisible()
    })
    ...
    test(`LABEL_USERNAME is visible`, () => {
      render(<App lang="en" />)
      expect(screen.getByText(index.en.LABEL_USERNAME)).toBeVisible()
    })

    test(`LABEL_FAV_FOOD is visible`, () => {
      render(<App lang="en" />)
      expect(screen.getByText(index.en.LABEL_FAV_FOOD)).toBeVisible()
    })

    test(`LABEL_ACCEPT_TERMS is visible`, () => {
      render(<App lang="en" />)
      expect(screen.getByText(index.en.LABEL_ACCEPT_TERMS)).toBeVisible()
    })
  ...
  describe('Spanish Language', () => {
    ...
    */
    ...
    test(`TEXT_FAV_LANG_JS is visible`, () => {
      render(<App lang="esp" />)
      expect(screen.getByText(index.esp.TEXT_FAV_LANG_JS)).toBeVisible()
    })

    test(`TEXT_FAV_LANG_RUST is visible`, () => {
      render(<App lang="esp" />)
      expect(screen.getByText(index.esp.TEXT_FAV_LANG_RUST)).toBeVisible()
    })
    ...
    test(`TEXT_SUBMIT is visible`, () => {
      render(<App lang="esp" />)
      expect(screen.getByText(index.esp.TEXT_SUBMIT)).toBeVisible()
    })
    ...
    test(`LABEL_USERNAME is visible`, () => {
      render(<App lang="esp" />)
      expect(screen.getByText(index.esp.LABEL_USERNAME)).toBeVisible()
    })

    test(`LABEL_FAV_FOOD is visible`, () => {
      render(<App lang="esp" />)
      expect(screen.getByText(index.esp.LABEL_FAV_FOOD)).toBeVisible()
    })

    test(`LABEL_ACCEPT_TERMS is visible`, () => {
      render(<App lang="esp" />)
      expect(screen.getByText(index.esp.LABEL_ACCEPT_TERMS)).toBeVisible()
    })
...
describe('getEntriesByKeyPrefix', () => {
  test('can extract the correct data', () => {
    ...
    const result = getEntriesByKeyPrefix(obj, keyPrefix);
    expect(result).toEqual(expected);
  });

  test("should return an empty array if no properties with given prefixes are found", () => {
